...
const PostBody = ({user, body, postedAt}) => {
  return (
    <div className="flex  border md:border px-4 md:px-10 py-7 border-r-transparent border-l-transparent border-t-transparent  border-b-transparent border-solid">
